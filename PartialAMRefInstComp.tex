...
\begin{alltt}
\pvsid{PartialAMRefInstComp}: \pvskey{THEORY}
 \pvskey{BEGIN}

  \pvskey{IMPORTING} \pvsid{FeatureModelSemantics}

  \pvskey{IMPORTING} \pvsid{ConfigurationKnowledge}

  \(c\): \pvskey{VAR} \pvsid{Configuration}\vspace*{\pvsdeclspacing}

  \pvsid{am}: \pvskey{VAR} \pvsid{AM}\vspace*{\pvsdeclspacing}

  \pvsid{ck}: \pvskey{VAR} \pvsid{CK}\vspace*{\pvsdeclspacing}

  \pvsid{eval}\pvsid{(}\pvsid{ck}\pvsid{)}\pvsid{(}\pvsid{am}\pvsid{)}\pvsid{(}\(c\)\pvsid{)}: \pvsid{AM} \pvskey{=} \pvsid{filter}\pvsid{(}\pvsid{eval}\pvsid{(}\pvsid{ck}, \(c\)\pvsid{)}, \pvsid{am}\pvsid{)}\vspace*{\pvsdeclspacing}
  ...
  \pvskey{IMPORTING} \pvsid{PartialAMCompositionality}
                \({\pvsbracketl}\)\pvsid{Name}.\pvsid{Configuration}, \pvsid{FeatureModel}.\pvsid{FM}, \pvsid{FeatureModelSemantics}.\pvsid{semantics}, \pvsid{Asset},
                  \pvsid{AssetName}, \pvsid{ConfigurationKnowledge}.\pvsid{CK}\({\pvsbracketr}\)
                \pvsid{\{\{}\pvsid{eval} := \pvsid{eval}, \pvsid{wfCK} := \pvsid{wfCK}\pvsid{\}\}}

 \pvskey{END} \pvsid{PartialAMRefInstComp}\end{alltt}
