...
\begin{alltt}
\pvsid{PartialRefBasics}\({\pvsbracketl}\)\pvsid{Conf}: \pvskey{TYPE}, \pvsid{FM}: \pvskey{TYPE}, \pvsid{\{||\}}: \({\pvsbracketl}\)\pvsid{FM} \(\rightarrow\) \pvsid{set}\({\pvsbracketl}\)\pvsid{Conf}\({\pvsbracketr}\)\({\pvsbracketr}\), \pvsid{Asset}: \pvskey{TYPE}, \pvsid{AssetName}: \pvskey{TYPE},
 ...
 \pvskey{BEGIN}
  ...
  \(s\): \pvskey{VAR} \pvsid{set}\({\pvsbracketl}\)\pvsid{Conf}\({\pvsbracketr}\)\vspace*{\pvsdeclspacing}

  \pvsid{fm1}, \pvsid{fm2}: \pvskey{VAR} \pvsid{FM}\vspace*{\pvsdeclspacing}
  ...
  \pvsid{ck1}, \pvsid{ck2}: \pvskey{VAR} \pvsid{CK}\vspace*{\pvsdeclspacing}

  \pvskey{IMPORTING} \pvsid{SPLrefinement}\({\pvsbracketl}\)\pvsid{Conf}, \pvsid{FM}, \pvsid{Asset}, \pvsid{AssetName}, \pvsid{CK}, \pvsid{\{||\}}, \pvsid{[||]}\({\pvsbracketr}\)

  \pvsid{am}, \pvsid{am1}, \pvsid{am2}: \pvskey{VAR} \pvsid{AM}\vspace*{\pvsdeclspacing}

  \pvsid{fmPartialRefinement}\pvsid{(}\pvsid{fm1}, \pvsid{fm2}, \(s\)\pvsid{)}: \pvsid{bool} \pvskey{=}
      \pvskey{forall} \(c\): \(s\)\pvsid{(}\(c\)\pvsid{)} \(\Rightarrow\) \pvsid{\{||\}}\pvsid{(}\pvsid{fm1}\pvsid{)}\pvsid{(}\(c\)\pvsid{)} \(\wedge\) \pvsid{\{||\}}\pvsid{(}\pvsid{fm2}\pvsid{)}\pvsid{(}\(c\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{fmPartRef}: \pvskey{LEMMA}
    \pvskey{forall} \pvsid{fm1}, \pvsid{fm2}:
      \pvsid{(}\pvsid{fm1} \(\models\) \pvsid{fm2}\pvsid{)} \(\Leftrightarrow\) \pvsid{fmPartialRefinement}\pvsid{(}\pvsid{fm1}, \pvsid{fm2}, \pvsid{\{|}\pvsid{fm1}\pvsid{|\}}\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{amPartialRef}\pvsid{(}\pvsid{am1}, \pvsid{am2}, \pvsid{anSet}\pvsid{)}: \pvsid{bool} \pvskey{=}
      \(\rhd\)\pvsid{(}\pvsid{filter}\pvsid{(}\pvsid{anSet}, \pvsid{am1}\pvsid{)}, \pvsid{filter}\pvsid{(}\pvsid{anSet}, \pvsid{am2}\pvsid{)}\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{ckWeakerEq}\pvsid{(}\pvsid{ck1}, \pvsid{ck2}, \(s\)\pvsid{)}: \pvsid{bool} \pvskey{=}
      \pvskey{forall} \pvsid{am}, \(c\):
        \(s\)\pvsid{(}\(c\)\pvsid{)} \(\Rightarrow\) \pvsid{[||]}\pvsid{(}\pvsid{ck1}\pvsid{)}\pvsid{(}\pvsid{am}\pvsid{)}\pvsid{(}\(c\)\pvsid{)} \(=\) \pvsid{[||]}\pvsid{(}\pvsid{ck2}\pvsid{)}\pvsid{(}\pvsid{am}\pvsid{)}\pvsid{(}\(c\)\pvsid{)}\vspace*{\pvsdeclspacing}

 \pvskey{END} \pvsid{PartialRefBasics}\end{alltt}
