...
\begin{alltt}
\pvsid{FormulaTheory}: \pvskey{THEORY}
 \pvskey{BEGIN}

  \pvskey{IMPORTING} \pvsid{FeatureModel}

  \pvsid{complexity}\pvsid{(}\(f\): \pvsid{Formula\_}\pvsid{)}: \(\mathbb{N}\) \pvskey{=}
      \pvsid{reduce\_nat}\pvsid{(}\(0\), \(0\), \pvskey{lambda} \pvsid{(}\(n\): \pvsid{Name}\pvsid{)}: \(1\), \pvskey{lambda} \pvsid{(}\(n\): \(\mathbb{N}\)\pvsid{)}: \(\opplustwofn{n}{1}\),
                  \pvskey{lambda} \pvsid{(}\(n\): \(\mathbb{N}\), \(m\): \(\mathbb{N}\)\pvsid{)}: \(\opplustwofn{\opplustwofn{n}{m}}{1}\),
                  \pvskey{lambda} \pvsid{(}\(n\): \(\mathbb{N}\), \(m\): \(\mathbb{N}\)\pvsid{)}: \(\opplustwofn{\opplustwofn{n}{m}}{1}\)\pvsid{)}
                \pvsid{(}\(f\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{names}\pvsid{(}\(f\): \pvsid{Formula\_}\pvsid{)}: \pvskey{RECURSIVE} \pvsid{set}\({\pvsbracketl}\)\pvsid{Name}\({\pvsbracketr}\) \pvskey{=}
    \pvskey{CASES} \(f\) \pvskey{OF}
      \pvsid{TRUE\_FORMULA}: \({\emptyset}\),
      \pvsid{FALSE\_FORMULA}: \({\emptyset}\),
      \pvsid{NAME\_FORMULA}\pvsid{(}\(n\sb{1}\)\pvsid{)}: \{\(n\): \pvsid{Name} | \(n\sb{1}\) \(=\) \(n\)\},
      \pvsid{NOT\_FORMULA}\pvsid{(}\(f\sb{1}\)\pvsid{)}: \pvsid{names}\pvsid{(}\(f\sb{1}\)\pvsid{)},
      \pvsid{AND\_FORMULA}\pvsid{(}\(f\sb{1}\), \(f\sb{2}\)\pvsid{)}: \{\(n\): \pvsid{Name} | \pvsid{names}\pvsid{(}\(f\sb{1}\)\pvsid{)}\pvsid{(}\(n\)\pvsid{)} \(\vee\) \pvsid{names}\pvsid{(}\(f\sb{2}\)\pvsid{)}\pvsid{(}\(n\)\pvsid{)}\},
      \pvsid{IMPLIES\_FORMULA}\pvsid{(}\(f\sb{1}\), \(f\sb{2}\)\pvsid{)}: \{\(n\): \pvsid{Name} | \pvsid{names}\pvsid{(}\(f\sb{1}\)\pvsid{)}\pvsid{(}\(n\)\pvsid{)} \(\vee\) \pvsid{names}\pvsid{(}\(f\sb{2}\)\pvsid{)}\pvsid{(}\(n\)\pvsid{)}\}
      \pvskey{ENDCASES}
     \pvskey{MEASURE} \pvsid{complexity}\pvsid{(}\(f\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{wt}\pvsid{(}\pvsid{fm}: \{\pvsid{featMod}: \pvsid{FM} | \pvsid{wfTree}\pvsid{(}\pvsid{featMod}\pvsid{)}\}, \(f\): \pvsid{Formula\_}\pvsid{)}: \pvskey{RECURSIVE} \pvsid{boolean} \pvskey{=}
    \pvskey{CASES} \(f\) \pvskey{OF}
      \pvsid{TRUE\_FORMULA}: \({\pvskey{TRUE}}\),
      \pvsid{FALSE\_FORMULA}: \({\pvskey{TRUE}}\),
      \pvsid{NAME\_FORMULA}\pvsid{(}\(n\)\pvsid{)}: \pvsid{(}\pvskey{exists} \pvsid{(}\(n\sb{1}\): \pvsid{Name}\pvsid{)}: \pvsid{features}\pvsid{(}\pvsid{fm}\pvsid{)}\pvsid{(}\(n\sb{1}\)\pvsid{)} \(\wedge\) \(n\sb{1}\) \(=\) \(n\)\pvsid{)},
      \pvsid{NOT\_FORMULA}\pvsid{(}\(f\sb{1}\)\pvsid{)}: \pvsid{wt}\pvsid{(}\pvsid{fm}, \(f\sb{1}\)\pvsid{)},
      \pvsid{AND\_FORMULA}\pvsid{(}\(f\sb{1}\), \(f\sb{2}\)\pvsid{)}: \pvsid{wt}\pvsid{(}\pvsid{fm}, \(f\sb{1}\)\pvsid{)} \(\wedge\) \pvsid{wt}\pvsid{(}\pvsid{fm}, \(f\sb{2}\)\pvsid{)},
      \pvsid{IMPLIES\_FORMULA}\pvsid{(}\(f\sb{1}\), \(f\sb{2}\)\pvsid{)}: \pvsid{wt}\pvsid{(}\pvsid{fm}, \(f\sb{1}\)\pvsid{)} \(\wedge\) \pvsid{wt}\pvsid{(}\pvsid{fm}, \(f\sb{2}\)\pvsid{)}
      \pvskey{ENDCASES}
     \pvskey{MEASURE} \pvsid{complexity}\pvsid{(}\(f\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{wfFormulae}\pvsid{(}\pvsid{fm}: \{\pvsid{featMod}: \pvsid{FM} | \pvsid{wfTree}\pvsid{(}\pvsid{featMod}\pvsid{)}\}\pvsid{)}: \pvsid{boolean} \pvskey{=}
      \pvskey{forall} \pvsid{(}\(f\): \pvsid{Formula\_}\pvsid{)}: \pvsid{formulae}\pvsid{(}\pvsid{fm}\pvsid{)}\pvsid{(}\(f\)\pvsid{)} \(\Rightarrow\) \pvsid{wt}\pvsid{(}\pvsid{fm}, \(f\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{satisfies}\pvsid{(}\(f\): \pvsid{Formula\_}, \(c\): \pvsid{Configuration}\pvsid{)}: \pvskey{RECURSIVE} \pvsid{boolean} \pvskey{=}
    \pvskey{CASES} \(f\) \pvskey{OF}
      \pvsid{TRUE\_FORMULA}: \({\pvskey{TRUE}}\),
      \pvsid{FALSE\_FORMULA}: \({\pvskey{FALSE}}\),
      \pvsid{NAME\_FORMULA}\pvsid{(}\(n\)\pvsid{)}: \pvsid{(}\pvskey{exists} \pvsid{(}\(n\sb{1}\): \pvsid{Name}\pvsid{)}: \(c\)\pvsid{(}\(n\sb{1}\)\pvsid{)} \(\wedge\) \(n\sb{1}\) \(=\) \(n\)\pvsid{)},
      \pvsid{NOT\_FORMULA}\pvsid{(}\(f\sb{1}\)\pvsid{)}: \(\neg\) \pvsid{satisfies}\pvsid{(}\(f\sb{1}\), \(c\)\pvsid{)},
      \pvsid{AND\_FORMULA}\pvsid{(}\(f\sb{1}\), \(f\sb{2}\)\pvsid{)}: \pvsid{satisfies}\pvsid{(}\(f\sb{1}\), \(c\)\pvsid{)} \(\wedge\) \pvsid{satisfies}\pvsid{(}\(f\sb{2}\), \(c\)\pvsid{)},
      \pvsid{IMPLIES\_FORMULA}\pvsid{(}\(f\sb{1}\), \(f\sb{2}\)\pvsid{)}: \pvsid{satisfies}\pvsid{(}\(f\sb{1}\), \(c\)\pvsid{)} \(\Rightarrow\) \pvsid{satisfies}\pvsid{(}\(f\sb{2}\), \(c\)\pvsid{)}
      \pvskey{ENDCASES}
     \pvskey{MEASURE} \pvsid{complexity}\pvsid{(}\(f\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{rename}\pvsid{(}\(f\): \pvsid{Formula\_}, \(x\), \(y\): \pvsid{Name}\pvsid{)}: \pvskey{RECURSIVE} \pvsid{Formula\_} \pvskey{=}
    \pvskey{CASES} \(f\) \pvskey{OF}
      \pvsid{TRUE\_FORMULA}: \pvsid{TRUE\_FORMULA},
      \pvsid{FALSE\_FORMULA}: \pvsid{FALSE\_FORMULA},
      \pvsid{NAME\_FORMULA}\pvsid{(}\(n\sb{1}\)\pvsid{)}: \pvskey{IF} \pvsid{(}\(n\sb{1}\) \(=\) \(x\)\pvsid{)} \pvskey{THEN} \pvsid{NAME\_FORMULA}\pvsid{(}\(y\)\pvsid{)} \pvskey{ELSE} \pvsid{NAME\_FORMULA}\pvsid{(}\(n\sb{1}\)\pvsid{)} \pvskey{ENDIF},
      \pvsid{NOT\_FORMULA}\pvsid{(}\(f\sb{1}\)\pvsid{)}: \pvsid{NOT\_FORMULA}\pvsid{(}\pvsid{rename}\pvsid{(}\(f\sb{1}\), \(x\), \(y\)\pvsid{)}\pvsid{)},
      \pvsid{AND\_FORMULA}\pvsid{(}\(f\sb{1}\), \(f\sb{2}\)\pvsid{)}: \pvsid{AND\_FORMULA}\pvsid{(}\pvsid{rename}\pvsid{(}\(f\sb{1}\), \(x\), \(y\)\pvsid{)}, \pvsid{rename}\pvsid{(}\(f\sb{2}\), \(x\), \(y\)\pvsid{)}\pvsid{)},
      \pvsid{IMPLIES\_FORMULA}\pvsid{(}\(f\sb{1}\), \(f\sb{2}\)\pvsid{)}: \pvsid{IMPLIES\_FORMULA}\pvsid{(}\pvsid{rename}\pvsid{(}\(f\sb{1}\), \(x\), \(y\)\pvsid{)}, \pvsid{rename}\pvsid{(}\(f\sb{2}\), \(x\), \(y\)\pvsid{)}\pvsid{)}
      \pvskey{ENDCASES}
     \pvskey{MEASURE} \pvsid{complexity}\pvsid{(}\(f\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{notInNames}: \pvskey{THEOREM}
    \pvskey{forall} \pvsid{(}\(f\): \pvsid{Formula\_}, \(x\), \(y\): \pvsid{Name}\pvsid{)}:
      \(\neg\) \pvsid{(}\pvsid{names}\pvsid{(}\(f\)\pvsid{)}\pvsid{(}\(x\)\pvsid{)}\pvsid{)} \(\Rightarrow\) \(f\) \(=\) \pvsid{(}\pvsid{rename}\pvsid{(}\(f\), \(x\), \(y\)\pvsid{)}\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{eqRename}: \pvskey{THEOREM}
    \pvskey{forall} \pvsid{(}\(f\): \pvsid{Formula\_}, \(x\), \(y\): \pvsid{Name}\pvsid{)}:
      \(\neg\) \pvsid{(}\pvsid{names}\pvsid{(}\(f\)\pvsid{)}\pvsid{(}\(y\)\pvsid{)}\pvsid{)} \(\Rightarrow\)
       \(f\) \(=\) \pvsid{rename}\pvsid{(}\pvsid{rename}\pvsid{(}\(f\), \(x\), \(y\)\pvsid{)}, \(y\), \(x\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{evalRename}: \pvskey{LEMMA}
  ...
  \pvsid{formNames}: \pvskey{LEMMA}
    \pvskey{forall} \pvsid{(}\pvsid{fm}: \{\pvsid{featMod}: \pvsid{FM} | \pvsid{wfTree}\pvsid{(}\pvsid{featMod}\pvsid{)}\}, \(f\): \pvsid{Formula\_}\pvsid{)}:
      \pvsid{wt}\pvsid{(}\pvsid{fm}, \(f\)\pvsid{)} \(\Rightarrow\)
       \pvsid{(}\pvskey{forall} \pvsid{(}\(n\): \pvsid{Name}\pvsid{)}: \pvsid{names}\pvsid{(}\(f\)\pvsid{)}\pvsid{(}\(n\)\pvsid{)} \(\Rightarrow\) \pvsid{features}\pvsid{(}\pvsid{fm}\pvsid{)}\pvsid{(}\(n\)\pvsid{)}\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{formNames2}: \pvskey{LEMMA}
    \pvskey{forall} \pvsid{(}\pvsid{fm}: \{\pvsid{featMod}: \pvsid{FM} | \pvsid{wfTree}\pvsid{(}\pvsid{featMod}\pvsid{)}\}, \(f\): \pvsid{Formula\_}, \(n\): \pvsid{Name}\pvsid{)}:
      \pvsid{wt}\pvsid{(}\pvsid{fm}, \(f\)\pvsid{)} \(\wedge\) \(\neg\) \pvsid{(}\pvsid{features}\pvsid{(}\pvsid{fm}\pvsid{)}\pvsid{(}\(n\)\pvsid{)}\pvsid{)} \(\Rightarrow\)
       \(\neg\) \pvsid{(}\pvsid{names}\pvsid{(}\(f\)\pvsid{)}\pvsid{(}\(n\)\pvsid{)}\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{satisfies1}: \pvskey{LEMMA}
    \pvskey{forall} \pvsid{(}\(f\): \pvsid{Formula\_}, \(c\): \pvsid{Configuration}, \(n\sb{1}\): \pvsid{Name}\pvsid{)}:
      \pvsid{(}\(\neg\) \pvsid{names}\pvsid{(}\(f\)\pvsid{)}\pvsid{(}\(n\sb{1}\)\pvsid{)}\pvsid{)} \(\Rightarrow\)
       \pvsid{satisfies}\pvsid{(}\(f\), \(c\)\pvsid{)} \(=\) \pvsid{satisfies}\pvsid{(}\(f\), \(\setsotheraddtwofn{n\sb{1}}{c}\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{satisfies2}: \pvskey{LEMMA}
    \pvskey{forall} \pvsid{(}\(f\): \pvsid{Formula\_}, \(c\): \pvsid{Configuration}, \(n\sb{1}\): \pvsid{Name}\pvsid{)}:
      \pvsid{(}\(\neg\) \pvsid{names}\pvsid{(}\(f\)\pvsid{)}\pvsid{(}\(n\sb{1}\)\pvsid{)}\pvsid{)} \(\Rightarrow\)
       \pvsid{satisfies}\pvsid{(}\(f\), \(c\)\pvsid{)} \(=\) \pvsid{satisfies}\pvsid{(}\(f\), \(\setsotherremovetwofn{n\sb{1}}{c}\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{wtFormSameFeatures}: \pvskey{LEMMA}
    \pvskey{forall} \pvsid{(}\pvsid{abs}, \pvsid{con}: \pvsid{FM}\pvsid{)}:
      \pvsid{features}\pvsid{(}\pvsid{abs}\pvsid{)} \(=\) \pvsid{features}\pvsid{(}\pvsid{con}\pvsid{)} \(\wedge\) \pvsid{wfTree}\pvsid{(}\pvsid{abs}\pvsid{)} \(\wedge\) \pvsid{wfTree}\pvsid{(}\pvsid{con}\pvsid{)} \(\Rightarrow\)
       \pvsid{(}\pvskey{forall} \pvsid{(}\(f\): \pvsid{Formula\_}\pvsid{)}: \pvsid{wt}\pvsid{(}\pvsid{abs}, \(f\)\pvsid{)} \(\Rightarrow\) \pvsid{wt}\pvsid{(}\pvsid{con}, \(f\)\pvsid{)}\pvsid{)}\vspace*{\pvsdeclspacing}

 \pvskey{END} \pvsid{FormulaTheory}\end{alltt}
