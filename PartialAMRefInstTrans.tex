...
\begin{alltt}
\pvsid{PartialAMRefInstTrans}: \pvskey{THEORY}
 \pvskey{BEGIN}

  \pvskey{IMPORTING} \pvsid{FeatureModelSemantics}
  ...
  \pvsid{ck}, \pvsid{ck1}, \pvsid{ck2}: \pvskey{VAR} \pvsid{CK}\vspace*{\pvsdeclspacing}
  ...
  \pvsid{eval}\pvsid{(}\pvsid{ck}\pvsid{)}\pvsid{(}\pvsid{am}\pvsid{)}\pvsid{(}\(c\)\pvsid{)}: \pvsid{AM} \pvskey{=} \pvsid{semanticCK}\pvsid{(}\pvsid{ck}, \pvsid{am}, \(c\), \({\emptyset}\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvskey{IMPORTING} \pvsid{PartialAMCompositionality}
                \({\pvsbracketl}\)\pvsid{Name}.\pvsid{Configuration}, \pvsid{FeatureModel}.\pvsid{FM}, \pvsid{FeatureModelSemantics}.\pvsid{semantics}, \pvsid{Asset},
                  \pvsid{AssetName}, \pvsid{CKtrans}.\pvsid{CK}\({\pvsbracketr}\)
                \pvsid{\{\{}\pvsid{eval} := \pvsid{eval},
                  \pvsid{wfCK}
                    := \pvsid{extend}
                           \({\pvsbracketl}\)\({\pvsbracketl}\)\pvsid{AM}
                                   \({\pvsbracketl}\)\pvsid{Name}.\pvsid{Configuration}, \pvsid{FeatureModel}.\pvsid{FM},
                                     \pvsid{FeatureModelSemantics}.\pvsid{semantics}, \pvsid{Asset}, \pvsid{AssetName},
                                     \pvsid{CKtrans}.\pvsid{CK}\({\pvsbracketr}\),
                               \({\pvsbracketr}\),
                             \({\pvsbracketl}\)\pvsid{AM}, \({\pvsbracketr}\), \pvsid{bool}, \({\pvskey{FALSE}}\)\({\pvsbracketr}\)
                           \pvsid{(}\pvsid{wfCK}\pvsid{)}\pvsid{\}\}}

  \pvsid{pl}: \pvskey{VAR} \pvsid{PL}\vspace*{\pvsdeclspacing}

  \pvsid{syntaxAddAssets}\pvsid{(}\pvsid{am1}, \pvsid{am2}, \pvsid{ck1}, \pvsid{ck2}, \pvsid{pairs}, \pvsid{its}\pvsid{)}: \pvsid{bool} \pvskey{=}
      \pvsid{am2} \(=\) \pvsid{overw}\pvsid{(}\pvsid{pairs}, \pvsid{am1}\pvsid{)} \(\wedge\) \pvsid{ck2} \(=\) \pvsid{append}\pvsid{(}\pvsid{its}, \pvsid{ck1}\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{conditionsAddAssets}\pvsid{(}\pvsid{pairs}, \pvsid{fm}, \pvsid{am}, \pvsid{ck}\pvsid{)}: \pvsid{bool} \pvskey{=}
      \pvskey{forall} \(c\):
        \pvsid{semantics}\pvsid{(}\pvsid{fm}\pvsid{)}\pvsid{(}\(c\)\pvsid{)} \(\Rightarrow\)
         \pvsid{empty?}\pvsid{(}\(\setsotherintersectiontwofn{\pvsid{dom}\pvsid{(}\pvsid{eval}\pvsid{(}\pvsid{ck}\pvsid{)}\pvsid{(}\pvsid{am}\pvsid{)}\pvsid{(}c\pvsid{)}\pvsid{)}}{\pvsid{dom}\pvsid{(}\pvsid{pairs}\pvsid{)}}\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{addAssetsPartRefStrong}: \pvskey{THEOREM}
    \pvskey{forall} \pvsid{(}\pvsid{pl}, \pvsid{am2}, \pvsid{ck2}, \(s\), \pvsid{its}, \pvsid{pairs}\pvsid{)}:
      \pvsid{(}\pvsid{(}\(s\) \(=\) \(\Diamond\) \pvsid{(}\pvsid{exps}\pvsid{(}\pvsid{its}\pvsid{)}, \(F\)\pvsid{(}\pvsid{pl2}\pvsid{)}\pvsid{)} \(\wedge\)
           \pvsid{syntaxAddAssets}\pvsid{(}\(A\)\pvsid{(}\pvsid{pl}\pvsid{)}, \pvsid{am2}, \(K\)\pvsid{(}\pvsid{pl}\pvsid{)}, \pvsid{ck2}, \pvsid{pairs}, \pvsid{its}\pvsid{)} \(\wedge\)
            \pvsid{conditionsAddAssets}\pvsid{(}\pvsid{pairs}, \(F\)\pvsid{(}\pvsid{pl}\pvsid{)}, \pvsid{am2}, \(K\)\pvsid{(}\pvsid{pl}\pvsid{)}\pvsid{)} \(\wedge\)
             \pvsid{(}\pvskey{forall} \(c\):
                 \(\neg\) \(s\)\pvsid{(}\(c\)\pvsid{)} \(\Rightarrow\)
        ...
        \pvskey{WHERE} \pvsid{pl2} \pvskey{=} \pvsid{(\#}\(F\) \pvskey{:=} \(F\)\pvsid{(}\pvsid{pl}\pvsid{)}, \(A\) \pvskey{:=} \pvsid{am2}, \(K\) \pvskey{:=} \pvsid{ck2}\pvsid{\#)}\vspace*{\pvsdeclspacing}

 \pvskey{END} \pvsid{PartialAMRefInstTrans}\end{alltt}
